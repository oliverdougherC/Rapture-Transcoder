...
def verify_transcoded_file(input_file, output_file):
    ...
    if output_codec != 'hevc':
        return False, f"Incorrect video codec: expected hevc, got {output_codec}"

    return True, "Verification passed"

def transcode_file(input_file, output_file, preset, preset_dir, encoder, quality, encoder_preset, prioritize_config, progress_callback=None, threads=None):
